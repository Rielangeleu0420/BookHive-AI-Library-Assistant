                                ...
                                <tr class="user-row" data-role="<?php echo $user['role']; ?>">
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            <button class="btn-action btn-edit" onclick="editUser(<?php echo $user['user_id']; ?>, '<?php echo htmlspecialchars($user['full_name']); ?>')" title="Edit User">
                                            ...
                                            <button class="btn-action btn-reset" onclick="resetPassword(<?php echo $user['user_id']; ?>, '<?php echo htmlspecialchars($user['full_name']); ?>')" title="Reset Password">
                                                <i data-lucide="key"></i>
                                            </button>
                                        </div>
                                    </td>
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Swal.fire({
                    ...
                    text: `Temporary password has been sent to ${userName}.`,
                    confirmButtonColor: '#10b981'
                });
            }
        });
